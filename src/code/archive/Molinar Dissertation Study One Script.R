...
Raw_Study_One_Data <- read_excel("C:/Users/bmoli/Documents/Dissertation/Dissertation Study 1 w Randomization.xlsx", range = "A4:EC410", sheet = "Dissertation Study 1 w Randomiz", col_names = Var_Col)
...
Raw_Study_One_Data$D7 = as.factor(Raw_Study_One_Data$D7) #Income#
#table(Raw_Study_One_Data$D7) #Mostly Middle#
Raw_Study_One_Data$D8 = as.factor(Raw_Study_One_Data$D8) #Subjective SES#
#table(Raw_Study_One_Data$D8) #Middle and Working#
...
table(Raw_Study_One_Data$Manip_Check_1)
table(Raw_Study_One_Data$Manip_Check_2)
table(Raw_Study_One_Data$Manip_Check_3)
...
#table(Raw_Study_One_Data$Manip_Check_1_Passed) #375 Passed#
...
#table(Raw_Study_One_Data$Manip_Check_2_Passed) #378 Passed#
...
#table(Raw_Study_One_Data$Manip_Check_3_Passed) #343 Passed#
...
#table(Raw_Study_One_Data$PASSED_ALL_ATTN) #315 Passed all Three#
...
RWA_1, RWA_2, RWA_3, RWA_4, RWA_5, RWA_6, RWA_7, RWA_8, RWA_9, RWA_10, RWA_11, RWA_12, RWA_13, RWA_14, RWA_15, PHNS_1, PHNS_2, PHNS_3, PHNS_4, PHNS_5, PHNS_6, PHNS_7, PHNS_8, PHNS_9, PHNS_10, PHNS_11, PHNS_12, PHNS_13, PHNS_14, LOT_1, LOT_2, LOT_3, LOT_4, LOT_5, LOT_6, D1, D4, D12, D13, D14, D15)


##Number of Missing Values in Frame##
table(is.na(Missing_Data_RF_FRAME)) #720/42735 = 1.7%#
...
Imputed_Raw_Data_Study_One <- cbind(First_Variables, Imputed_Data[,1:100], Demo_1, Imputed_Data[,101], Demo_2, Imputed_Data[,102:105], Demo_3)
...
table(Passed_Study_One_Data$Worst_Future > Passed_Study_One_Data$Best_Future)
##Number of People where the present is higher than the best possible future##
table(Passed_Study_One_Data$Present > Passed_Study_One_Data$Best_Future)
...
table(Passed_Study_One_Data$Positive_Potential > Passed_Study_One_Data$Absolute_Potential) #14#
##Number of people with more Negative than absolue potential#
table(Passed_Study_One_Data$Negative_Potential < Passed_Study_One_Data$Absolute_Potential) #27#
