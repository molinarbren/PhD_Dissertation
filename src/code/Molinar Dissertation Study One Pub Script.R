...
Mod_Best_Fut = interact_plot(GLM_Moderation_FWB_Best_Future, pred = "D4", modx = "FWB", plot.points = FALSE, interval = TRUE, color.class = c('#91bfdb','#af8dc3', '#fc8d59'), x.label = "Political Orientation (Conservative High)", y.label = "Best Future", legend.main = "Free Will Beliefs", main.title = "") + theme(plot.title = element_text(hjust = 0.5, size = 16, face = "bold"), axis.text=element_text(size=16,face = "bold"), axis.title=element_text(size=16,face = "bold"), legend.text=element_text(size=14), legend.title = element_text(size=16))
...
Mod_Pos_Po = interact_plot(GLM_Moderation_FWB_Pos_Po, pred = "D4", modx = "FWB", plot.points = FALSE, interval = TRUE, color.class = c('#91bfdb','#af8dc3', '#fc8d59'), x.label = "Political Orientation (Conservative High)", y.label = "Positive Potential", legend.main = "Free Will Beliefs", main.title = "") + theme(plot.title = element_text(hjust = 0.5, size = 16, face = "bold"), axis.text=element_text(size=16,face = "bold"), axis.title=element_text(size=16,face = "bold"), legend.text=element_text(size=14), legend.title = element_text(size=16))
